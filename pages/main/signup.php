...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $confirmPassword = $_POST['inputPassword6'];
  ...
  if ($password !== $confirmPassword) {
    ...
    $sql = "INSERT INTO taikhoan (taiKhoan, matKhau, maNhomQuyen) VALUES ('$email', '$password', 'nhanvien')";
...
<body class="light ">
  <div class="wrapper vh-100">
    ...
    <div class="form-group">
        ...
        <input type="int" class="form-control" id="inputEmail4" name="inputEmail">
    </div>
    <!-- <div class="form-row">
