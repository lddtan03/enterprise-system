...
<div class="wrapper vh-100">
  <div class="row align-items-center h-100">
    <form class="col-lg-3 col-md-4 col-10 mx-auto text-center" id="resetPasswordForm">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Hướng dẫn đặt lại mật khẩu đã được gửi về gmail của bạn. Bạn sẽ được chuyển lại ra trang đăng nhập</p>
      </div>
