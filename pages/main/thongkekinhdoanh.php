<main role="main" class="main-content">
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                <h2 class="page-title">Thống kê kho hàng</h2>
                <div class="card shadow">
                    <div class="card-body">
                        <ul class="nav nav-tabs mb-3" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="thang-tab" data-toggle="tab" href="#thang" role="tab"
                                    aria-controls="thang" aria-selected="true">Tháng</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="nam-tab" data-toggle="tab" href="#nam" role="tab"
                                    aria-controls="nam" aria-selected="true">Năm</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="quy-tab" data-toggle="tab" href="#quy" role="tab"
                                    aria-controls="quy" aria-selected="false">Quý</a>
                            </li>
                        </ul>
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="thang" role="tabpanel"
                                    ...
                                    <div class="col-md-6 col-xl-3 mb-4">
                                        <div class="card shadow">
                                            <div class="card-header">
                                                ...
                                                <a class="float-right small text-muted" href="#!"><i
                                                        class="fe fe-more-vertical fe-12"></i></a>
                                            </div>
                            ...
                            <div class="tab-pane fade" id="nam" role="tabpanel" aria-labelledby="nam-tab">
                                <div class="row">
                                    <div class="col-md-6 col-xl-3 mb-4">
                                        <div class="card shadow bg-primary text-white">
                                            <div class="card-body">
                            ...
                            <div class="tab-pane fade" id="quy" role="tabpanel" aria-labelledby="quy-tab">
                                <div class="row">
                                    <div class="col-md-6 col-xl-3 mb-4">
                                        <div class="card shadow bg-primary text-white">
                                            <div class="card-body">
